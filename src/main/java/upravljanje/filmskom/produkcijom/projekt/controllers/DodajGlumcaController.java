...
public class DodajGlumcaController {
    ...
    public void dodajGlumca() {
        try {
            ...
            Glumac glumac = new Glumac(Long.valueOf(0), Ime, Prezime, oib, Dob, Umjetnicko, Nominacije, Nagrade, projekt, pocetak);

            Database.dodajGlumca(glumac);
