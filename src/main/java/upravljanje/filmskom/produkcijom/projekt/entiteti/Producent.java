...
public class Producent extends Osoba implements Popularnost, ZapisPromjena {
    ...
    public Producent(Long idOsobe, String ime, String prezime, String OIB, Integer dob, String umjetnickoIme, Integer brojNominacija, Integer brojNagrada,  Projekt trenutniProjekt, LocalDate pocetakRada) {
    ...
    public String toString() {
        return "{" +
                ...
                ", trenutniProjekt=" + trenutniProjekt +
    ...
    public void Serijalizacija(String filepath) {
        try {
            ...
            Producent producent = new Producent(getIdOsobe(), getIme(), getPrezime(), getOIB(), getDob(), getUmjetnickoIme(), getBrojNominacija(), getBrojNagrada(), getTrenutniProjekt(), getPocetakRada());
            zapisivanje.writeObject(producent);
            zapisivanje.close();
        } catch (IOException e) {
            e.printStackTrace();
